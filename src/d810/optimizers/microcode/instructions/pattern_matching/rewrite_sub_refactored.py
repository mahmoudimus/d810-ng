...
class Sub_HackersDelight1(VerifiableRule):
    """Simplify: x + (~y + 1) => x - y
...
class Sub_HackersDelight2(VerifiableRule):
...
class Sub_HackersDelight3(VerifiableRule):
...
class Sub_HackersDelight4(VerifiableRule):

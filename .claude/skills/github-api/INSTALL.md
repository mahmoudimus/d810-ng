...
```bash
$GH pr list --repo <GITHUB-REPO-OWNER>/<GITHUB-REPO-NAME> --limit 3
```
...
curl -sL https://github.com/cli/cli/releases/download/v2.83.1/gh_2.83.1_linux_amd64.tar.gz -o gh.tar.gz && \
tar xzf gh.tar.gz && \

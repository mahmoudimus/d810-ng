...
WHY THIS IS IN system/ TESTS:
    ...
    Python. However, they're in system/ because the RULE_REGISTRY is populated
...
from d810.mba.rules import RULE_REGISTRY, VerifiableRule
...
def test_all_rules_have_descriptions():
    ...
    """
    unnamed_rules = [
        rule for rule in RULE_REGISTRY if rule.description in ["No description", ""]
    ]
